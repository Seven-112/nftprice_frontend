...
import { clearNfts, clearFilter, fetchNftsRarity } from '../../components/store/actions';
...
const ColumnTopCollections = ({ showLoadMore = true, shuffle = false, authorId = null }) => {
...
export default memo(ColumnTopCollections);